...
# Model Options
# modified by zyl 2020/12/13 22:00  parser.add_argument('--embedding_dim', default=64, type=int)
parser.add_argument('--embedding_dim', default=16, type=int)
parser.add_argument('--num_layers', default=1, type=int)
parser.add_argument('--dropout', default=0, type=float)
parser.add_argument('--batch_norm', default=0, type=bool_flag)
# modified by zyl 2020/12/13 22:15  parser.add_argument('--mlp_dim', default=1024, type=int)
parser.add_argument('--mlp_dim', default=64, type=int)

# Generator Options
# modified by zyl 2020/12/13 20:51  parser.add_argument('--encoder_h_dim_g', default=64, type=int)
parser.add_argument('--encoder_h_dim_g', default=32, type=int)
# modified by zyl 2020/12/13 21:40  parser.add_argument('--decoder_h_dim_g', default=128, type=int)
parser.add_argument('--decoder_h_dim_g', default=32, type=int)
# modified by zyl 2020/12/14  parser.add_argument('--noise_dim', default=None, type=int_tuple)
parser.add_argument('--noise_dim', default=(8, ), type=int_tuple)
parser.add_argument('--noise_type', default='gaussian')
# modified by zyl 2020/12/14  parser.add_argument('--noise_mix_type', default='ped')
parser.add_argument('--noise_mix_type', default='global')
# modified by zyl 2020/12/14  parser.add_argument('--clipping_threshold_g', default=0, type=float)
parser.add_argument('--clipping_threshold_g', default=2.0, type=float)
# modified by zyl 2020/12/13 20:51  parser.add_argument('--g_learning_rate', default=5e-4, type=float)
...
# modified by zyl 2020/12/14  parser.add_argument('--d_type', default='local', type=str)
parser.add_argument('--d_type', default='global', type=str)
# modified by zyl 2020/12/13 21:40  parser.add_argument('--encoder_h_dim_d', default=64, type=int)
...
# modified by zyl 2020/12/14  parser.add_argument('--print_every', default=5, type=int)
parser.add_argument('--print_every', default=100, type=int)
# modified by zyl 2020/12/14  parser.add_argument('--checkpoint_every', default=100, type=int)
...
TrajectoryGenerator(
  ...
  (pool_net): GCNPooling(
    (spatial_embedding): Linear(in_features=2, out_features=16, bias=True)
    (gcn_pooling_net_intra): GCN(
      (W): ParameterList(
          (0): Parameter containing: [torch.cuda.FloatTensor of size 48x72 (GPU 0)]
          (1): Parameter containing: [torch.cuda.FloatTensor of size 72x8 (GPU 0)]
      )
    )
    (gcn_pooling_net_inter): GCN(
      (W): ParameterList(
          (0): Parameter containing: [torch.cuda.FloatTensor of size 48x72 (GPU 0)]
          (1): Parameter containing: [torch.cuda.FloatTensor of size 72x8 (GPU 0)]
      )
...
[INFO: train.py:  184]: Here is the discriminator:
[INFO: train.py:  185]: TrajectoryDiscriminator(
  (encoder): Encoder(
    (spatial_embedding): Linear(in_features=2, out_features=16, bias=True)
    (encoder): LSTM(16, 48)
  )
